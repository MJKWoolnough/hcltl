...
const userFilter = Array.from({"length": users.length}, () => true),
	...
	g({"transform": "translate(10, 10)"}, [
      ...
      settingsWindow = windows({"window-icon": "data:image/svg+xml," + encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\"" + settings.outerHTML.slice(13, -11).replaceAll("#aaa", "#000")), "window-title": "Settings"}, [
	      h1("Settings"),
